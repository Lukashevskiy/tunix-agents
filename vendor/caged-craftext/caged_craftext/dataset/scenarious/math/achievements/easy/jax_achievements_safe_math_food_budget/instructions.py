...
from caged_craftext.environment.scenarious.checkers.constrained_target_state import ConstrainedTargetState as CMDPTargetState, BudgetByAction, TargetAction
...
def create_target_state(required=[], forbidden=[], action_list: list = [Action.DO], minuses: list = [10]):
    ...
    budget_by_action = BudgetByAction(budget=20, delimiter_actions=actions, target_action=TargetAction.FOOD.value)

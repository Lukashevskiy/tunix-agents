...
| `22_external_vllm_sync_grpo_rollout.ipynb` | Use direct `VllmInferenceEngine` rollout, build `ExternalGrpoBatch`, compute token GRPO loss and run one compact actor Optax update before PPO/critic work. |

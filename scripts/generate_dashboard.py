...
API_MODULES = (
    ...
    "tunix_craftext.core.contracts",
    "tunix_craftext.core.resources",
    "tunix_craftext.core.tensor_types",
    "tunix_craftext.env.config",
    "tunix_craftext.env.runtime",
    "tunix_craftext.env.prompts",
    "tunix_craftext.env.text_policy",
    "tunix_craftext.env.agentic_craftext",
    "tunix_craftext.rollouts.reference",
    "tunix_craftext.rollouts.batched",
    "tunix_craftext.rollouts.hybrid",
    "tunix_craftext.rollouts.text_episode",
    "tunix_craftext.artifacts.replay",
    "tunix_craftext.artifacts.text_trajectory",
    "tunix_craftext.artifacts.profiling",
    "tunix_craftext.artifacts.checkpoints",
    "tunix_craftext.models.llm",
    "tunix_craftext.models.llm_actor",
    "tunix_craftext.models.profile",
    "tunix_craftext.models.tunix_adapter",
    "tunix_craftext.models.tunix_actor",
    "tunix_craftext.training.experience_builders",
    "tunix_craftext.training.agentic_ppo",
    "tunix_craftext.training.grpo_profile",

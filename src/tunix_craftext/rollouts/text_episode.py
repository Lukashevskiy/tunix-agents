...
from ..env.prompts import ActionCatalog, PromptContext, PromptRenderer, compose_craftext_goal
from ..env.text_policy import DecodedAction, decode_action, decode_action_outcome
from ..models.llm import LlmBackend, LlmRequest
    ...
    for index, key in enumerate(keys[1:]):
        ...
        steps.append(
            ReplayStep(
                ...
                action_mask=tuple(bool(x) for x in transition.action_mask),

...
Contracts in this module express time-major rollout tensors, terminal semantics,
...
class RolloutBatch(Generic[ObservationT, ActionT]):
    ...
    :ivar transitions: Transition[ObservationT, ActionT]
    :ivar bootstrap_value: jax.Array
...
def _shape_of(value: object, field_name: str) -> tuple[int, ...]:
    ...
    :param field_name: str input value
    :returns: tuple[int, ...]

    Example:
        >>> result = _shape_of(value, field_name)"""
...
def _validate_tree_axes(value: object, field_name: str, expected_axes: tuple[int, ...]) -> None:
    ...
    :param value: input value
    :param field_name: str input value
    :param expected_axes: tuple[int, ...] input value
    :returns: None

    Example:
        >>> result = _validate_tree_axes(value, field_name, expected_axes)"""
...
def _register_contract_pytrees() -> None:
    ...
    Example:
        >>> result = _register_contract_pytrees()"""

...
`RLCluster`, а также делает один Optax update компактного prompt-conditioned actor-а как
проверяемый локальный алгоритмический контур. Это стартовая база для

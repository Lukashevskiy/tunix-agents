...
explicit local Qwen snapshot and walks through environment reset, prompt rendering, Tunix
sampling, strict decode with visible fallback, one CrafText action and replay v2 persistence.

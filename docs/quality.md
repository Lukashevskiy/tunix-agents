...
| Unit coverage | общий coverage core modules, branch-aware | `make coverage` / `pytest tests/unit --cov=src/tunix_craftext --cov-fail-under=83` |
...
uv run python scripts/benchmark_text_pipeline.py \
